            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if "dog" in label: # Change depending on classes in .yaml file
                            coord_1_grey = xyxy
                        ...
                        try:
                            if len(coords_red) > 0 and len(coords_grey) > 0: # Check if red or grey array has any elements
                                diff = numpy.subtract(int(coords_grey[-1]),
                                                      int(coords_red[-1]))  # [-1] for last element, determines the
                                # difference of the y coordinate of the lowest part of the bounding box
                            ...
                            print("Not enough data")
                        print("Grey coords:", coords_grey) # Will print only current coords of grey
                        #print("Grey labels:", labels_grey) # Will print every label
                        print("Red coords:", coords_red) # Will print only current coords of red
            ...
            if save_img:
                if dataset.mode == 'image':
                    ...
                    if vid_path != save_path:  # new video
                        print("vid path type", type(vid_path))
                        print("vid path:", vid_path)
                        print("save path type", type(save_path))
                        vid_path = save_path
