...
```bash
python train.py --img 640 --batch 16 --epochs 3 --data datasettest.yaml --weights yolov5s.pt --cache
```
...
```bash
cd datasettest
clearml-data sync --project YOLOv5 --name datasettest --folder .
```
...
clearml-data create --name datasettest --project YOLOv5
